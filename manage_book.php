...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container-fluid">
			...
			<font style="color: white"><span><strong>E Mail: <?php echo $_SESSION['email'];?></strong></font>
		...
		<div class="container-fluid">
		    ...
		    <ul class="nav navbar-nav navbar-center">
		      ...
		      <li class="nav-item dropdown">
	        	...
	        	<div class="dropdown-menu">
	        		<a class="dropdown-item" href="add_book.php">Add New Books</a>
	        		<div class="dropdown-divider"></div>
		      ...
		      <li class="nav-item dropdown">
	        	...
	        	<div class="dropdown-menu">
	        		<a class="dropdown-item" href="add_cat.php">Add New Categories</a>
	        		<div class="dropdown-divider"></div>
		      ...
		      <li class="nav-item dropdown">
	        	...
	        	<div class="dropdown-menu">
	        		<a class="dropdown-item" href="add_author.php">Add New Authors</a>
	        		<div class="dropdown-divider"></div>
